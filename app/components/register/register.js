                ...
                <nav className="main-nav navbar navbar-default navbar-static-top" role="navigation" >
                    <div className="container">
                        <div className="navbar-header">
                            ...
                            <a className="navbar-brand" href="#">Bolunteer</a>
                        </div>
                            ...
                            <div className="col-sm-12 col-md-10">
                                <div className="login-panel panel panel-default semi-opaque">
                                    <div className="panel-heading">
                                        <h1 className="panel-title text-center large-h1 ">Start Bolunteering</h1>
                                    </div>
                    ...
                    <div className="row footer-bottom">
                        <div className="container">
                            <div className="col-sm-12 footer-txt">
                                ...
                                <span className="pull-right">Bolunteer &copy; 2018 Proudly created as part of the eMerge Americas Wyncode Hackathon.</span>
                            </div>
                        </div>
                    </div>
                </footer>
