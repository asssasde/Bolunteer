        ...
        return (
            ...
            <div className="modal-dialog  modal-lg" role="document">
                ...
                <div className="modal-header">
                    <h1 className="modal-title" id="exampleModalLongTitle">How to Blounteer</h1>
                ...
                <div className="modal-body">
                    ...
                    <div className="row">
                        <div className="col-sm-8">
                            <h2>Earn Badges</h2>
                            <p>You deserve it. Proudly earn your badges as you complete your volunteering hour goals. You're on your way to becoming a Bolunteer aficionado!</p>
                        </div>
                        <div className="col-sm-4">
