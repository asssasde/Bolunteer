...
var Profile = React.createClass({
    ...
    render: function () {
        ...
        // set user image to default if no url exists (http://wpshowdown.com/wp-content/plugins/all-in-one-seo-pack/images/default-user-image.png)
        var userImage;
        if (this.state.image_url !== "") {
            userImage = <img src={this.state.image_url} className="img-circle margin-top-50 user-img" height="200px" alt="user image" />
        } else {
            userImage = <img src="http://fillmurray.com/g/300/300" className="img-circle margin-top-50 user-img" height="200px" alt="default image" />
        }
